...
-- !Find restraunt id from link
-- SELECT substring_index(link,'-',-1) from restaurants;
-- !Updating restraunt_id in the original table
-- CREATE TABLE IF NOT EXISTS rest_1 as
-- (
--     SELECT *,substring_index(link,'-',-1) from restaurants
-- );
-- SELECT * from rest_1;
-- !Clean the name column and update it on yhe table
-- CREATE TABLE IF NOT EXISTS rest_2 as
-- (
--     SELECT *,trim(name) as new_name from restaurants
-- );
-- SELECT * from rest_2;
